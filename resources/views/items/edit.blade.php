    ...
    <body>
        <div class="bg-yellowkou pt-10 px-14 pb-14">
            <div class="p-6 px-20 bg-yelloekou_2">
                <h1 class="text-center sm:text-8xl font-dela mx-auto container pt-8 pl-6">防災用食品を編集する</h1>
                <form action="/items/{{ $item->id }}" method="POST" class="justify-center">
                    ...
                    <div class="flex justify-between mb-8">
                        ...
                        <div class="size-32 font-dela border border-red1 bg-red1 rounded-full flex justify-center items-center shadow-md p-2 hover:bg-red2">
                            <input type="submit" value="編集" class="text-2xl size-28 border-dashed border-4 rounded-full border-white"/>
                        </div>
                    </div>
                </form>
            </div>
